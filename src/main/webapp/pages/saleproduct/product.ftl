	...
	<body>
		<div class="page">
			...
			<div class="protit">
				...
				<#if productid? exists && productid == "19" >
					<div class="price"><img src="http://cilu.com.cn/emp/activity_19.png" width="70%">
					
					<!-- 剩几天显示此 -->
					<div class="pgoods_time off" id="clockbox" style="bottom:20px;">
         ...
         <form  id="form1" name="form1" method="post">
             ...
             <#if isDiscount ? exists && isDiscount == 2>
             	<input type="hidden" name="productcount" value="1" />　 <!-- 打折单商品的数量　-->
             <#else>
