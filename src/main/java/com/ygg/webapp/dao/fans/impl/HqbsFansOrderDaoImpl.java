...
public class HqbsFansOrderDaoImpl extends BaseDaoImpl implements HqbsFansOrderDao {
	...
	/**
	 * 根据粉丝订单id和粉丝用户id 查询粉丝订单List
	 * @param para
	 * @return
	 */
	@Override
	public List<QqbsFansOrderEntity> getFansOrderAccountIdAndWithdrawCash(int fansOrderId, int fansAccountId) {
		Map<String, Object> map = new HashMap<String, Object>();
        map.put("fansOrderId", fansOrderId);
        map.put("fansAccountId", fansAccountId);
        return this.getSqlSession().selectList("HqbsFansOrderMapper.getFansOrderAccountIdAndWithdrawCash", map);
	}
	
	/**
	 * 根据上级用户id和订单状态   查询粉丝订单List
	 * @param para
	 * @return
	 */
	@Override
	public List<QqbsFansOrderEntity> getWithdrawcashList(int accountId, byte status) {
        ...
        map.put("status", status);
        return this.getSqlSession().selectList("HqbsFansOrderMapper.getWithdrawcashList", map);
	}
	...
	public int updateWithdrawcash(int id, float withdrawCash) {
		Map<String, Object> map = new HashMap<String, Object>();
        map.put("id", id);
        map.put("withdrawCash", withdrawCash);
        return this.getSqlSession().update("HqbsFansOrderMapper.updateWithdrawcash", map);
	}
