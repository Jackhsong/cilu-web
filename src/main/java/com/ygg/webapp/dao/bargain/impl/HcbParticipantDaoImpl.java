...
public class HcbParticipantDaoImpl extends BaseDaoImpl implements HcbParticipantDao {
	...
	@Override
	public List<HcbParticipant> HcbParticipantlistOfActivity() {

    	List<HcbParticipant> participantList = getSqlSession().selectList("HcbParticipantMapper.HcbParticipantlistOfActivity");
