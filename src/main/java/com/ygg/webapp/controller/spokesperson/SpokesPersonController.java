...
public class SpokesPersonController
{
        ...
        throws Exception
    {
        ...
        //account.setImage("http://weishang201605.b0.upaiyun.com/qqbsAccount/wechatImage/6120D2215FA313CB.jpg");
        // account.setNickName("咖啡加个蛋");
        // account.setAccountId(164640189);
