...
public class WeChatCallbackController {
	...
	private String getBargainUrl(int accountId, String fromUserName, String toUserName) {
		...
		str.append("<CreateTime>" + new Date().getTime() + "</CreateTime>");
		str.append("<MsgType><![CDATA[news]]></MsgType>");
		str.append("<ArticleCount><![CDATA[4]]></ArticleCount>");
		str.append("<Articles>");
		str.append("<item>");
		str.append("<Title><![CDATA[立即帮" + accountEntity.getNickName() + "砍价]]></Title>");
		str.append("<PicUrl><![CDATA[" + baseDefaultUrl + "resources/bargain/images/poster1.png]]></PicUrl>");
		str.append("<Url><![CDATA[" + baseDefaultUrl + "bargain/activity_b_17?accountId=" + String.valueOf(accountId)
		        + "]]></Url>");
		str.append("</item>");
		str.append("<item>");
		str.append("<Title><![CDATA[别这样，你太狠了！]]></Title>");
		...
		str.append("<item>");
		str.append("<Title><![CDATA[疯抢中! 痘胶膏2折限时抢购！]]></Title>");
		str.append("<PicUrl><![CDATA[" + baseDefaultUrl + "resources/bargain/images/aty17_c.jpg]]></PicUrl>");
		str.append("<Url><![CDATA[" + baseDefaultUrl + "product/single/19]]></Url>");
		str.append("</item>");
		
		str.append("<item>");
		str.append("<Title><![CDATA[下次活动预告：慈露本草足膜砍价]]></Title>");
		str.append("<PicUrl><![CDATA[" + baseDefaultUrl + "resources/bargain/images/aty17_b.jpg]]></PicUrl>");
		str.append("<Url><![CDATA[" + baseDefaultUrl + "bargain/next_activity_17]]></Url>");
		str.append("</item>");
		str.append("</Articles>");
		str.append("</xml>");
