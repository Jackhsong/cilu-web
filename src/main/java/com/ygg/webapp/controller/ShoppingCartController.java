        ...
        try
        {
            ...
            // 成功
            {
                ...
                if (productListJson != null)
                {
                    ...
                    {
                    	ProductEntity pe = productService.findProductById(Integer.valueOf(pv.getProductId()));
                    	//打折商品的isDiscunt为2，购买打折商品时，必须至少下单两件
                    	/*if(pe.getIsDiscount() == 2 && Integer.valueOf(pv.getCount()) <= 1){
                    		 count = 2;
                    	}else{
                    		 count = Integer.parseInt(pv.getCount());
                    	}*/
